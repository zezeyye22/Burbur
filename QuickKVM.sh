...
sudo apt update && sudo apt install -y qemu-kvm bridge-utils virt-manager virt-viewer spice-vdagent libhugetlbfs-bin libvirt-clients qemu-utils virt-manager ovmf spice-vdagent && \
