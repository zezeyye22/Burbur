...
sudo apt update && sudo apt install -y qemu-kvm bridge-utils virt-manager virt-viewer libhugetlbfs-bin libvirt-clients qemu-utils virt-manager ovmf ssh-askpass spice-vdagent && \
