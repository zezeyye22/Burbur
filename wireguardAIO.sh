...
#       - For a maximum security it will be use through ssh tunnel (ssh -L 6000:localhost:6000 user@vpn.domain.tld)
...
##################################################################################
  ...
  - To access your wireguard-ui please open a new ssh connexion
      - ssh -L 6000:localhost:5000 user@myserver.domain.tld
